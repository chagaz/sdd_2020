...
\item Expliciter le principe de la minimisation du risque empirique, et
  l'illustrer sur un ou deux exemples d'algorithme d'apprentissage automatique ;
...
\item Décrire un réseau de neurones artificiel comme un modèle paramétrique ;
