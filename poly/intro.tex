...
enrichie par des techniques de réduction de dimension (voir chapitre TODO REF),
qui permettent de créer un petit nombre de variables qui résument les mesures
prises sur les observations, et des techniques de partitionnement, ou
clustering, qui permettent de réduire la taille d'un échantillon en regroupant
les individus présentant des caractéristiques homogènes (ce sujet sera abordé
plus en détail dans TODO nom cours ML avancé. Nous détaillons la statistique
...
non-supervisé / exploratoire / analyse exploratoire de données ; vs
apprentissage supervisé. Reprendre intro Dunod.


\section{Déroulé du cours et évaluation}
Le document que vous êtes en train de lire vit sur GitHub :
\href{https://github.com/chagaz/sdd\_2020}{https://github.com/chagaz/sdd\_2020}.
