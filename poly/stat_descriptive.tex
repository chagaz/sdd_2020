...
En découvrant les exemples de ce chapitre, demandez-vous quelles hypothèses les
valeurs d'indicateurs et les visualisations graphiques vous suggèrent.
...
verrons au chapitre~\ref{chap:tests} comment transformer cette distance en un test
