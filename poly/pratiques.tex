...
vocation à être un cours d'éthique\footnote{L'éthique peut être rapidement
...
impact fort sur le message que vous essayez de faire passer. Mi-mai 2020, le
Department of Public Health de l'État de Géorgie (États-Unis d'Amérique) a
publié le diagramme en barres de la figure ~\ref{fig:georgia_wtf_barplot}
. Regardez bien l'axe des abscisses : le message vous semble-t-il le même quand
les dates sont ordonnées de manière chronologique, comme sur la version
corrigée de ce diagramme, sur la figure~\ref{fig:georgia_fixed_barplot} ?
...
Il existe des ouvrages entiers sur la visualisation de données (souvent appelée
\textit{dataviz} en anglais). Nous allons ici citer quelques principes parmi
les plus importants.
...
\subsection{L'encre proportionnelle}
%https://callingbullshit.org/tools/tools_proportional_ink.html
De manière générale, il est recommandé, lorsque l'on utilise des surfaces pour représenter des nombres (par exemple, les rectangles d'un diagramme en barres), que ces surfaces soient d'aires proportionnelles aux nombres en question. 

On retrouve ici la notion de commencer les barres d'un diagramme en barres à 0.

Il faut cependant faire aussi attention à ce que les surfaces en question soient faciles à comparer visuellement. Un diagramme camembert est ainsi préférable à un graphique en bulles ; mais un diagramme en barres est généralement plus lisible qu'un diagramme camembert.
\begin{figure}[h]
  \centering
  ...
  \end{subfigure} 
  \caption{Trois façons de représenter les proportions de 8 catégories.}
  %\label{fig:georgia_barplot}
\end{figure}



\subsection{Boîtes à moustache}
...
Les \href{https://fr.wikipedia.org/wiki/M\%C3\%A9thode\_formelle\_(informatique)}{\textbf{méthodes
  formelles}}
...
de neurones artificiels (que nous évoquerons au chapitre~\ref{chap:nonlin}) le
sont beaucoup moins. 
...
personnes. Comment s'assurer que les données qui nous concernent, qu'elles
soient médicales, de localisation géographique, ou concernent notre activité
numérique, soient utilisées à bon escient ? 

Les discussions autour des applications de traçage de contacts dans la lutte
contre la propagation du coronavirus vont
\href{https://risques-tracage.fr/}{actuellement bon train}, illustrant cette
préoccupation.
...
personne de manière unique quand elles sont croisées avec d'autres données (par
exemple, code postal, date de naissance et lieu de travail pris ensembles
...
\label{sec:ecology}
Enfin, le bilan écologique du numérique n'est pas négligeable. 

\href{https://www.ademe.fr/sites/default/files/assets/documents/guide-pratique-face-cachee-numerique.pdf}{Selon
  l'ADEME} (anciennement Agence De l'Environnement et de la Maîtrise
Énergétique et actuelle Agence de la Transition Écologique), le secteur du
numérique est responsable de 4\% des émissions mondiales de gaz à effet de
serre, dont un quart dûs aux data centers; entraîner un réseau de neurones
artificiels comportant 213 millions de paramètres peut générer
\href{https://arxiv.org/abs/1906.02243}{autant d'émissions de CO2 que cinq
  voitures américaines} pendant toute leur existence, fabrication comprise.

Le \href{https://mlco2.github.io/impact/}{Machine Learning Emissions
  Calculator} est un des outils qui accompagnent cette prise de conscience.


\begin{plusloin}
\item La question de la représentativité des données se pose dans de nombreux
  domaines de l'ingénierie. Des
  \href{https://www.huffingtonpost.fr/2017/08/19/ce-distributeur-automatique-ne-distribue-pas-de-savon-aux-mains\_a\_23152387/}{distributeurs
    de savon automatiques qui ne détectent que les peaux claires} à tous les
  objets plutôt adaptés aux hommes qu'aux femmes recensés par Caroline Criado
  Perez dans
  \href{https://www.liberation.fr/france/2020/03/06/les-femmes-invisibles-dans-un-monde-cree-pour-les-hommes\_1780895}{\textit{Invisible
      Women}}, les exemples sont nombreux.
  \item Un épisode de La Méthode Scientifique à écouter (ou le transcrit à
    lire) du 10 octobre 2018 intitulé « Éthique numérique, des data sous
    serment
    » \href{https://april.org/ethique-numerique-des-datas-sous-serment-emission-la-methode-scientifique}{ici}.
  \item L'ouvrage en ligne (et en cours de rédaction)
    \href{https://fairmlbook.org/}{Fairness and Machine Learning} by Solon
    Barocas, Moritz Hardt and Arvind Narayanan.
  \item Quelques articles en ligne sur la justice prédictive :
    \begin{itemize}
    \item \href{https://www.latribune.fr/supplement/ceux-qui-transforment-la-france/la-justice-predictive-nouvel-outil-pour-les-professionnels-du-droit-837752.html}{La justice prédictive, nouvel outil pour les professionnels du droit} ;
    \item \href{https://intelligence-artificielle.developpez.com/actu/264160/La-France-bannit-les-IA-de-prediction-des-comportements-des-juges-les-technologies-de-justice-predictive-sont-elles-une-menace-pour-la-societe/}{La France bannit les IA de prédiction des comportements} ;
    \item
      \href{https://www.dalloz-actualite.fr/flash/justice-et-intelligence-artificielle-preparer-demain-episode-i#.XsvEykNS8Xc}{Justice
        et intelligence artificielle : préparer demain}.
    \end{itemize}
  \item \textit{The Hidden Biases in Big Data}, Kate Crawford, HBR, April 2013. \href{https://hbr.org/2013/04/the-hidden-biases-in-big-data}{https://hbr.org/2013/04/the-hidden-biases-in-big-data}
  \item Pour en savoir plus sur la confidentialité différentielle : \href{https://salil.seas.harvard.edu/files/salil/files/differential_privacy_primer_nontechnical_audience.pdf}{\textit{Differential privacy: A primer for a non-technical audience}}, A. Wood et al., Vanderbilt Journal of Entertainment and Technology Law.
\end{plusloin}
