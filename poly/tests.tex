...
pour hypothèse nulle $\HH_0: \theta = \theta_0$, le domaine de rejet sera de la
forme
\begin{itemize}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/tests/z_pigeons}
...
Ainsi l'intervalle 
\[
  I = \left[ M_n - \frac{\hat{\sigma}}{\sqrt{n}} z_0, 
      M_n + \frac{\hat{\sigma}}{\sqrt{n}} z_0   \right]
\]
est un \textbf{intervalle de confiance} à $(1 - \alpha)$ pour la taille moyenne $\mu$.

Dans notre exemple, l'intervalle de confiance à 95\% pour la valeur moyenne du
poids d'un pigeon est $[302,4\si{g}~; 321,6\si{g}]$.
$\mu_0$ n'est pas dans l'intervalle de confiance ; on adopte l'hypothèse
...
TODO Intervalle de confiance pour le test unilatéral.
